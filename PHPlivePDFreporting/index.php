...
<body>
	...
	<form action="" method="post">
		<input type="text" name="keyboard" size="40" autofocus placeholder="cari disini" autocomplete="off" id="keyboard">
		<button type="submit" name="cari" id="btnsearch">Cari</button>
	</form>
