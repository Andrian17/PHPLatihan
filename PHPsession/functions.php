...
function registrasi($data){
	...
	$result = mysqli_query($con, "SELECT username FROM userlogin WHERE username = '$username'");
...
//masukkan ke dalam data base
	mysqli_query($con, "INSERT INTO userlogin VALUES ( '', '$username', '$password') ");
	return mysqli_affected_rows($con);
